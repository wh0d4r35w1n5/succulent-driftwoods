...
var DefaultRequestBuilder = /** @class */ (function () {
    function DefaultRequestBuilder(_httpClient, _baseUrlProvider, _apiErrorCtr, _authenticationProvider, _httpMethod, _xmlSerializer, _retryConfig, _streamReadTimeout, _path, _apiLogger) {
        ...
        this._streamReadTimeout = _streamReadTimeout;
        this._path = _path;
    ...
    DefaultRequestBuilder.prototype.callAsEventStream = function (createEventStream) {
    ...
    DefaultRequestBuilder.prototype._clone = function () {
        var cloned = new DefaultRequestBuilder(this._httpClient, this._baseUrlProvider, this._apiErrorCtr, this._authenticationProvider, this._httpMethod, this._xmlSerializer, this._retryConfig, this._streamReadTimeout, this._path, this._apiLogger);
...
function createRequestBuilderFactory(httpClient, baseUrlProvider, apiErrorConstructor, authenticationProvider, retryConfig, xmlSerializer, apiLogger, streamReadTimeout) {
    return function (httpMethod, path) {
        return new DefaultRequestBuilder(httpClient, baseUrlProvider, apiErrorConstructor, authenticationProvider, httpMethod, xmlSerializer !== null && xmlSerializer !== void 0 ? xmlSerializer : new xmlSerializer_1.XmlSerialization(), retryConfig, streamReadTimeout, path, apiLogger);
    };
}
