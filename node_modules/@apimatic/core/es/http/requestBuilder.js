...
function createRequestBuilderFactory(httpClient, baseUrlProvider, apiErrorConstructor, authenticationProvider, retryConfig, xmlSerializer, apiLogger, streamReadTimeout) {
  return function (httpMethod, path) {
    return new DefaultRequestBuilder(httpClient, baseUrlProvider, apiErrorConstructor, authenticationProvider, httpMethod, xmlSerializer !== null && xmlSerializer !== void 0 ? xmlSerializer : new XmlSerialization(), retryConfig, streamReadTimeout, path, apiLogger);
  };
}
